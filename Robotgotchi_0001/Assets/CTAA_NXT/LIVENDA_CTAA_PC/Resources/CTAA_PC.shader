...
// CTAA NXT V3 Cinematic Temporal Anti-Aliasing Copyright 2017-2021 Livenda Labs Pty Ltd 
...
//  Section No Longer required!
 ...
 float2 hDGFGHRHDfghmmFOgfhPRgrRGH = tex2D(_CameraMotionVectorsTexture, i.uv).rg;
...
*/
			...
			half4 UEWditFzRERTffhgfgedWLOJ= 
			hDGFhmmFO34sdgfhPGH5fzGD  + 
			hDGFhm34sdgfytyuhPGH5fzGD  +
			IKDSJHFGKJHEUIygEHJGFHG  +
			IKIFDHJrGKJHEUIygEHJGFHG  +
			IKIDFOIKfdJHEUIygEHJGFHG  +
			IKIDFOIKfdJHEUgfht6dIygFHG  +
			IKOIKfdJHEUgfht6dIfgygFHG  +
			IKOIKfdJHEUIfgygFHGghzF  +
			IKOIKfdJHEUIFHGghzFGFD ;

			UEWditFzRERTffhgfgedWLOJ /= 9;
