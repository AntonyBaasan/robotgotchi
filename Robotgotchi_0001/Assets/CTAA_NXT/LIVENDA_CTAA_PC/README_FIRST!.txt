IMPORTANT TO READ FOR CTAA NXT V3, PLEASE ALSO READ THE Documentation Update Even if you had a Previous version of CTAA
...
So, our recommendation for VR will be to use the Open VR version together with 2xMSAA when in forward render mode. The SuperSampling option in CTAA NXT is not available in VR due to extreme  high performance requirements, It is also not necessary as CTAA in VR is more then sufficient to achieving great results.
